  ...
  return (
    <main className="min-h-screen bg-background">
      <section className="container mx-auto max-w-5xl px-4 py-12 md:py-16">
        ...
        <p className="mt-3 text-muted-foreground">SonicRelay requires Play Console declarations for login, device registration, private sessions, and WebRTC signaling.</p>
      </section>
    </main>
  );
};
